...
outPath = "/home/conteinerFiles/FinalResults/Tests/" + snapshotName + "_speedTest"
...
confMatrixLogFile = open('/home/conteinerFiles/pspnet/pspnetpython/network/' + snapshotName + '/'+ modelName + '_' + baseName + '_timeTest.log', 'a+')
...
for idx in myFiles:
    count = count + 1
    inputImagePath = os.path.join(caminhoIn, idx)
